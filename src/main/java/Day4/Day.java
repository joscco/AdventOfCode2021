...
public class Day extends AbstractDay {
    ...
    public void solveDay() {
        ...
        List<String> values = InputUtils.readInLinesWithEmpties(getInputStream());
